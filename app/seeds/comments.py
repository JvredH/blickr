...
def seed_comments():
  ...
  comment7 = Comment(comment='What an impressive shot' , date=date(2022, 9, 30) , photo_id=7 , user_id=3)
  ...
  comment11 = Comment(comment='Awesome work!' , date=date(2023, 2, 20) , photo_id=11 , user_id=3)
