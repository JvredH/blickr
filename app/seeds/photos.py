...
def seed_photos():
  photo1 = Photo(url='https://live.staticflickr.com/65535/48712674607_6224279e6b_c.jpg', name='Canyon Vibes' , description='Photo was taken out in the canyons' , date=date(2022, 2, 22) , user_id=1)
  photo2 = Photo(url='https://live.staticflickr.com/8302/29005742911_3f516b8883_c.jpg' , name='Random photo I took' , description='Out at the lake and enjoying this view' , date=date(2022, 1, 22) , user_id=1)
  photo3 = Photo(url='https://live.staticflickr.com/737/31844162061_db4cb4fef9_h.jpg', name='At the lake' , description='Took a drive out to see the lake and saw this stunning view.' , date=date(2023, 1, 10) , user_id=1)
  photo4 = Photo(url='https://live.staticflickr.com/1592/25730475136_9e9e76b4fc_h.jpg' , name='Beach Day' , description='Went to the beach to snap some flicks today.' , date=date(2022, 8, 22) , user_id=1)
